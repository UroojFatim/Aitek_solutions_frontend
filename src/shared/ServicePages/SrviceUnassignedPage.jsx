...
export function ServiceUnassignedPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center min-h-screen px-4">
      ...
      <p className="text-sm sm:text-base md:text-lg text-light-muted dark:text-dark-muted max-w-lg">
        Interested in signing up for this service?
        <br />Please let our admin team know, and we’ll be happy to begin your onboarding.
      </p>
    </div>
  );
}

export default ServiceUnassignedPage;
