                      ...
                      >
                        ...
                        <div className="mt-2 flex items-center justify-between text-[11px] text-light-muted dark:text-dark-muted">
                          <div className="flex items-center gap-2 text-light-muted dark:text-dark-muted">
                            ...
                            <button
                              type="button"
                              className="rounded-full p-1 transition hover:bg-light-background dark:hover:bg-dark-background hover:text-light-text dark:hover:text-dark-text disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:text-inherit"
                              disabled
                              onClick={(e) => {
                                e.stopPropagation();
